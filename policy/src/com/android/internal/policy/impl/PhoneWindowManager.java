...
//phm
               ...
               Intent intent = new Intent();  
                intent.setAction("tigerbox_go_home"); 
...
/*
	...
	PowerManager pm = (PowerManager)mContext.getSystemService(Context.POWER_SERVICE);
	 wakeLock = pm.newWakeLock(PowerManager.FULL_WAKE_LOCK | PowerManager.ACQUIRE_CAUSES_WAKEUP, "pms");
    }
...
//                        i.putExtra("presstime",(now-mKeyDownTime));
	...
	if (mstate.equals("on") && ((keyCode == KeyEvent.KEYCODE_ENTER)
        ...
        // phm@yf-space.com add
            ...
            if (down) {
             	   Intent intent = new Intent();  
                intent.setAction("com.android.bts84.nfcout"); 
                mContext.sendBroadcast(intent);
             		
                Log.d("phm---------","com.android.bts84.nfcout");
            }
            return -1;
        }
            ...
            if (down)
             {
             	   Intent intent = new Intent();  
                intent.setAction("com.android.bts84.nfcin"); 
                mContext.sendBroadcast(intent);
             		
                Log.d("phm---------","com.android.bts84.nfcin");
            }
            return -1;
        }
